...
public class MemberController {
        ...
        public WebResponse<LogoutResponseWebModel> logout(@RequestHeader("Authorization") String request) {
        ...
        public WebResponse<GetUserDetailResponseWebModel> getUserDetail(@RequestParam String userId) {
                GetUserDetailCommandRequest commandRequest = GetUserDetailCommandRequest.builder()
                                .id(userId)
                                .build();
                GetUserDetailCommandResponse response = commandExecutor.execute(GetUserDetailCommand.class,
                                commandRequest);
