...
public class GetListProductCommandImpl implements GetListProductCommand {
    ...
    public GetListProductCommandResponse doCommand(GetListProductCommandRequest commandRequest) {
        ...
        String key = "product_list_" + commandRequest.getSearch() + "_" + commandRequest.getCategory() + "_"
                + commandRequest.getMinPrice() + "_" + commandRequest.getMaxPrice() + "_" + commandRequest.getBrand()
                + "_" + page + "_" + size;
        ...
        List<GetListProductCommandResponse.ProductInfo> productCommandResponse = mapProductToResponse(productPage,
                categoryMap);
        cacheService.set(key, productCommandResponse);

        // Build response with pagination metadata
        return GetListProductCommandResponse.builder()
